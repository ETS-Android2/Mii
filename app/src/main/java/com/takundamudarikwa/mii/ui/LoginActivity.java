...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBtn.setOnClickListener(v -> saveNewUser(givenName.getText(),familyName.getText(),email.getText(),phone.getText()));
    ...
    public void saveNewUser(CharSequence givenName, CharSequence  familyName, CharSequence  email, CharSequence phone){
